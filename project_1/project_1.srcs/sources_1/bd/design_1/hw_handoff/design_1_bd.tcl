...
# Hierarchical cell: heartBeat_approx1Hz
proc create_hier_cell_heartBeat_approx1Hz { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_msg_id "BD_TCL-102" "ERROR" "create_hier_cell_heartBeat_approx1Hz() - Empty argument(s)!"}
     return
  }
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins CLK] [get_bd_pins c_counter_binary_0/CLK]
...
proc create_root_design { parentCell } {
  ...
  set adc_dat_a_i [ create_bd_port -dir I -from 15 -to 2 adc_dat_a_i ]
  set adc_dat_b_i [ create_bd_port -dir I -from 15 -to 2 adc_dat_b_i ]
  ...
  # Create instance: ADCs_wrapper_0, and set properties
  set block_name ADCs_wrapper
  set block_cell_name ADCs_wrapper_0
  if { [catch {set ADCs_wrapper_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $ADCs_wrapper_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: DACs_wrapper_0, and set properties
  set block_name DACs_wrapper
  set block_cell_name DACs_wrapper_0
  if { [catch {set DACs_wrapper_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $DACs_wrapper_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: WaveformGen_ctrl_0, and set properties
  set block_name WaveformGen_ctrl
  set block_cell_name WaveformGen_ctrl_0
  if { [catch {set WaveformGen_ctrl_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $WaveformGen_ctrl_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  # Create instance: axi_gpio_firmwareVersion, and set properties
  set axi_gpio_firmwareVersion [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 axi_gpio_firmwareVersion ]
  set_property -dict [ list \
   CONFIG.C_ALL_INPUTS {1} \
 ] $axi_gpio_firmwareVersion
  ...
  set_property -dict [ list \
   CONFIG.CONST_VAL {0x0DAC0001} \
   CONFIG.CONST_WIDTH {32} \
 ] $firmwareVersion

  # Create instance: heartBeat_approx1Hz
  create_hier_cell_heartBeat_approx1Hz [current_bd_instance .] heartBeat_approx1Hz
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_IMPORT_BOARD_PRESET {D:/Alex/Red Pitaya/red_pitaya.xml} \
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M04_AXI [get_bd_intf_pins axi_gpio_firmwareVersion/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M04_AXI]

  # Create port connections
  connect_bd_net -net ADCs_wrapper_0_adc_cdcs_o [get_bd_ports adc_cdcs_o] [get_bd_pins ADCs_wrapper_0/adc_cdcs_o]
  connect_bd_net -net DACs_wrapper_0_dac_clk_o [get_bd_ports dac_clk_o] [get_bd_pins DACs_wrapper_0/dac_clk_o]
  connect_bd_net -net DACs_wrapper_0_dac_dat_o [get_bd_ports dac_dat_o] [get_bd_pins DACs_wrapper_0/dac_dat_o]
  connect_bd_net -net DACs_wrapper_0_dac_rst_o [get_bd_ports dac_rst_o] [get_bd_pins DACs_wrapper_0/dac_rst_o]
  ...
  connect_bd_net -net WaveformGen_ctrl_0_s_axis_mm2s_cmd_tdata [get_bd_pins WaveformGen_ctrl_0/s_axis_mm2s_cmd_tdata] [get_bd_pins axi_datamover_0/s_axis_mm2s_cmd_tdata] [get_bd_pins ila_0/probe3]
  ...
  connect_bd_net -net axi_datamover_0_m_axis_mm2s_tdata [get_bd_pins axi_datamover_0/m_axis_mm2s_tdata] [get_bd_pins xlslice_0/Din]
  connect_bd_net -net axi_datamover_0_m_axis_mm2s_tvalid [get_bd_pins DACs_wrapper_0/dac_a_tvalid] [get_bd_pins axi_datamover_0/m_axis_mm2s_tvalid] [get_bd_pins ila_0/probe2]
  ...
  connect_bd_net -net xlconstant_1_dout [get_bd_pins DACs_wrapper_0/dac_b_tvalid] [get_bd_pins xlconcat_0/In2] [get_bd_pins xlconcat_0/In3] [get_bd_pins xlconcat_0/In4] [get_bd_pins xlconcat_0/In5] [get_bd_pins xlconcat_0/In6] [get_bd_pins xlconstant_1/dout]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x800F0000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_gpio_firmwareVersion/S_AXI/Reg] SEG_axi_gpio_firmwareVersion_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x80010000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs xadc_wiz_0/s_axi_lite/Reg] SEG_xadc_wiz_0_Reg
